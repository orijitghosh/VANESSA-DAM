...
p <- alletho <-
            ...
            My_Theme
          alletho
          ggsave(p, filename = "Plot all actograms", type = "cairo",height = 30,
       width = 10, dpi = 600, units = "in")    ###############height = 10*n where n is number of genotypes
###############and width = 10
```
...
p <- ggetho(dt_curated,
            ...
            My_Theme +
            scale_fill_distiller(palette = "Blues")
          ggsave(p, filename = "Plot curated ethograms", type = "cairo",height = 30,
       width = 10, dpi = 600, units = "in")    ###############height = 10*n where n is number of genotypes
###############and width = 10
```
...
p <- alletho <-
            ...
            My_Theme
          alletho
          ggsave(p, filename = "Plot curated actograms", type = "cairo",height = 30,
       width = 10, dpi = 600, units = "in")    ###############height = 10*n where n is number of genotypes
###############and width = 10
```
